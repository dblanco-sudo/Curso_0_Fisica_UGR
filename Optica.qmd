...
#subtitle: "Curso Cero de Física - Facultad de Ciencias"
format: 
  html: default
  pdf: 
    pdf-engine: pdflatex
...
![Onda Electromagnética, donde $\vec S$ es la dirección de propagación.<br><small>Modificado a partir de un original de SuperManu (vía Wikimedia Commons), bajo licencia CC BY-SA 3.0.</small>](Onda_Electromagnetica.png){width=50%}
:::
...
::: {style="text-align:center;"}
![Espectro Electromagnético. <br><small>Modificado a partir de un original de Ignacio Icke (vía Wikimedia Commons), basado en NASA/Inductiveload.</small>](Espectro_Electromagnetico.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Reflexión y Refracción de una onda en una superficie](Reflexion_Refraccion.png){width=50%}
:::
...
:::{style="text-align:center;"}
![$n_1<n_2$](Refraccion_Caso1.png){width=40%}
:::
...
:::{style="text-align:center;"}
![$n_1>n_2$](Refraccion_Caso2.png){width=40%}
:::
...
::: {style="text-align:center;"}
![Ángulo límite](Reflexion_Total.png){width=100%}

:::

::: {style="text-align:center;"}
![Reflexión total interna](Reflexion_Total2.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Esquema de un lápiz en un vaso con agua.](lapiz_vaso.png){width=30%}
:::
...
::: {style="text-align:center;"}
![Imagen real](Objeto_Imagen1.png){width=100%}

:::

::: {style="text-align:center;"}
![Imagen virtual](Objeto_Imagen2.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Esquema de una imagen real, menor e invertida.](arbol_SO.png){width=80%}
:::
...
::: {style="text-align:center;"}
![Foco objeto real](Foco_Objeto.png){width=100%}

:::

::: {style="text-align:center;"}
![Foco imagen real](Foco_Imagen.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Distancias y tamaños, objeto e imagen.](arbol_lente.png){width=80%  fig-alt="Distancias y tamaños, objeto e imagen." .lightbox #fig-distancias}
:::
...
::: {style="text-align:center;"}
![Trazado de rayos. Rayo paralelo (azul), focal (verde) y central (rojo).](marcha_rayos.png){width=80% .lightbox #fig-lente-delgada}
:::
...
::: {style="text-align:center;"}
![Lentes convergentes.](Lentes_Convergentes.png){width=80%}
:::
...
::: {style="text-align:center;"}
![Lentes divergentes.](Lentes_Divergentes.png){width=80%}
:::
...
::: {style="text-align:center;"}
![Foco imagen de lente convergente](Lente_convergente_foco.png){width=100%}

:::

::: {style="text-align:center;"}
![Foco imagen de lente divergente](Lente_divergente_foco.png){width=100%}
:::
...
::: {style="text-align:center;"}
![Marcha de rayos de una lente convergente](Marcha_lente_a_7.png){width=80%}
...
::: {style="text-align:center;"}
![Marcha de rayos de una lente divergente](Marcha_lente_c_7.png){width=80%}
...
::: {style="text-align:center;"}
![Foco imagen de un espejo cóncavo](Foco_imagen_espejo.png){width=60%}

:::

::: {style="text-align:center;"}
![Foco objeto de un espejo cóncavo](Foco_objeto_espejo.png){width=60%}
:::
...
::: {style="text-align:center;"}
![Marcha de rayos en un espejo cóncavo](Marcha_rayos_espejo_concavo.png){width=40%}

:::

::: {style="text-align:center;"}
![Marcha de rayos en un espejo convexo](Marcha_rayos_espejo_convexo.png){width=90%}
:::
